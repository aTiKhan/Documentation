...
- /apidoc: holds generated api docs from src
...
The contents of the folder `/apidocs` were generated by running `docfx metadata` from this directory, with the Steeltoe source code cloned into the same directory as this repository.
